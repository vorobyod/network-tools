...
class NetCat:
    ...
    #
    # We either run in terminal mode or
    # listening and waiting for commands to run (-lceu)
    #
    def run(self):
        if self.args.listen:
            self.listen()
    ...
    #
    # Communicate with the network target
    #
    def send(self):
    ...
    #
    # Accept client connection and run the handler thread
    #
    def listen(self):
